...
export default function ReviewRequestPage({ params }) {
  ...
  const fetchRequestDetails = async () => {
    try {
      const res = await fetch(`/api/mobile-api/admin/apartment-requests?status=all`);
      if (res.ok) {
        const data = await res.json();
        const foundRequest = data.data.requests.find(
  ...
  const submitReview = async (action) => {
    ...
    try {
      const res = await fetch(`/api/mobile-api/admin/apartment-requests/${requestId}`, {
        method: 'PUT',
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Review Request</h1>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold text-slate-900">{request.userEmail}</p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {request.floorNumber && (
              <div>
                ...
                <p className="font-semibold text-slate-900">{request.floorNumber}</p>
              </div>
            )}
            <div>
              ...
              {request.ruleResponses.map((response, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <h3 className="font-semibold text-slate-900">{response.ruleName}</h3>
                  ...
                  {response.textResponse && (
                    <div className="mb-3 p-3 bg-white rounded border border-slate-200">
                      ...
                      <p className="text-sm text-slate-900">{response.textResponse}</p>
                    </div>
                  )}
            ...
            >
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">Reject Request</h2>
                </div>
